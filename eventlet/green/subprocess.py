...
class Popen(subprocess_orig.Popen):
    ...
    if not subprocess_orig.mswindows:
        ...
        _communicate = function(subprocess_orig.Popen._communicate.im_func.func_code,
                                    globals())
        try:
            _communicate_with_select = function(
                subprocess_orig.Popen._communicate_with_select.im_func.func_code,
                globals())
            _communicate_with_poll = function(
...
call = function(subprocess_orig.call.func_code, globals())
check_call = function(subprocess_orig.check_call.func_code, globals())
